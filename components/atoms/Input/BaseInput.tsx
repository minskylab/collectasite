...
const InputWrapper = styled.div<InputWrapperProps>`
  ...
  border-bottom: 1px;
  //@ts-ignore
  border-bottom-color: ${props => props.focus ? props.borderBottomFocusColor : props.borderBottomColor};
...
function BaseInput(props: InputProps): ReactElement {
  ...
  return (
    <InputWrapper focus={focus} borderBottomColor={theme.inputBorderBottomColor} borderBottomFocusColor={theme.inputBorderBottomFocusColor}>
      {props.label ? (
