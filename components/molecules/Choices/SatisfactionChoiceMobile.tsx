    ...
    color: ${(props: SatisfactionButtonProps) =>
        !props.selected
            ? props.focus
                ...
                : props.textColor || ""
            : props.textFocusColor || ""};
    border-color: ${(props: SatisfactionButtonProps) =>
        !props.selected
            ? props.focus
...
const SatisfactionChoiceMobile: FC<SatisfactionProps> = (props: SatisfactionProps) => {
    ...
    const _value = Math.round((props.unitValue / step + Math.round(sizeMode / 2) + Number.EPSILON) * 100) / 100;
    ...
    const insert = (list: any, newListItem: any) => {
        ...
        // setFocus(_focus);
        const sidesNumber = (sizeMode - 1) / 2;
        let first;
        let last;
                            ...
                            <SatisfactionButton
                                ...
                                textFocusColor={
                                    theme.satisfactionTextColors[
                                        ((theme.satisfactionTextColors.length - 1) / (sizeMode - 1)) * (optionValue - 1)
                                    ]
                                }
