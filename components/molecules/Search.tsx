    ...
    <Wrapper>
      ...
      <WrapperIcons>
        <WrapperIcon onClick={() => handleClick("CardMode")}>
          <CardModeIcon color={props.selected === "CardMode" ? defaults.activeColor : defaults.disableColor} />
        </WrapperIcon>
        <div style={{ height: "20px", width: "2px", backgroundColor: "#89A9B7", marginLeft: "0.6rem", marginRight: "0.6rem" }}></div>
        <WrapperIcon onClick={() => handleClick("ListMode")}>
          <ListModeIcon color={props.selected === "ListMode" ? defaults.activeColor : defaults.disableColor} />
        </WrapperIcon>
      </WrapperIcons>
    </Wrapper>
  );
